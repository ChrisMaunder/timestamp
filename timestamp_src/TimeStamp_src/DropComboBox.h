...
// Operations
public:
    static int     GetFileType(LPCTSTR szFile);
    static BOOL    IsDirectory(LPCTSTR szFile);
    static BOOL    IsFile(LPCTSTR szFile);
    static BOOL    Exist(LPCTSTR szFile);
    static CString ExpandShortcut(CString& csFilename);
